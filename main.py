...
def save_plots(real_position, measured_position, kalman_position, real_speed, kalman_speed, measured_error,
    ...
    plt.plot(times, kalman_position, label='Odfiltrowane położenie')
    plt.xlabel('czas (s)')
    ...
    plt.plot(times[200:400], kalman_position[200:400], label='Odfiltrowane położenie')
    plt.legend()
    plt.xlabel('czas (s)')
    plt.ylabel('położenie (m)')
    ...
    plt.plot(times, real_speed, label='Faktyczna szybkość')
    plt.plot(times, kalman_speed, label='Estymowana szybkosć')
    plt.xlabel('czas (s)')
    ...
    plt.clf()
    plt.plot(times[200:400], real_speed[200:400], label='Faktyczna szybkość')
    plt.plot(times[200:400], kalman_speed[200:400], label='Estymowana szybkość')
    plt.legend()
    plt.xlabel('czas (s)')
    plt.ylabel('szybkość (m/s)')
